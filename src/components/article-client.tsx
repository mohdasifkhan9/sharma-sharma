        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2 hidden lg:flex flex-col gap-6 sticky top-28 h-fit border-r border-line/45 pr-6">
            ...
            <button
              ...
              className="flex items-center gap-2 text-[10px] tracking-wider text-navy/70 hover:text-gold uppercase font-mono transition-colors cursor-pointer text-left"
            >
